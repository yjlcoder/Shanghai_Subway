...
function initLink1(){
    if(lineComponent.status == Component.Ready){
        ...
        links[linkCount].point1x = stations[links[linkCount].leftNode].x + 15
        links[linkCount].point1y = stations[links[linkCount].leftNode].y + 15
        links[linkCount].point2x = stations[links[linkCount].rightNode].x + 15
        links[linkCount].point2y = stations[links[linkCount].rightNode].y + 15
